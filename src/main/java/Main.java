...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("\tTime elapsed on 'Arrays.toString': " + String.valueOf(elapsedNanosString) + " milliseconds\n");
        ...
        System.out.println("\tTime elapsed on 'Arrays.copyOf': " + String.valueOf(elapsedNanosCopy) + " milliseconds\n");
        ...
        System.out.println("2.1.3. Arrays are equal: " + String.valueOf(arrayCompare));
        System.out.println("\tTime elapsed on 'Arrays.compare': " + String.valueOf(elapsedNanosCompare) + " milliseconds\n");
        ...
        System.out.println("2.2.1. Linear Search found element at index: " + String.valueOf(indexL));
        System.out.println("\tTime elapsed: " + String.valueOf(elapsedNanosLinearSearch) + " milliseconds\n");
        ...
        System.out.println("2.2.2. Binary Search found element at index: " + String.valueOf(indexB));
        System.out.println("\tTime elapsed: " + String.valueOf(elapsedNanosBinarySearch) + " milliseconds\n");
        ...
        System.out.println("\tTime elapsed: " + String.valueOf(elapsedNanosSort) + " milliseconds\n");
